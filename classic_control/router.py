...
class Router():
	def __init__(self, routes_fn):
		...
		self.global_students_dict=self.get_global_students_dict()

	def get_global_students_dict(self):
		while self.global_students_dict is None:
			_, self.global_students_dict=self.route_local_search()
		return self.global_students_dict
	...
	def get_demand(self):
		...
		#print(self.global_students_dict)
